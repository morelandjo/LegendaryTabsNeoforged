...
/**
 * Tab for Apothic Attributes (modid {@code attributeslib} on 1.20.1). The mod doesn't
 * add its own screen — its {@code AttributesGui} is a {@link net.minecraft.client.gui.components.Renderable}
