...
public abstract class ConfigurableCustomIconTab extends CustomIconTab {
    ...
    /**
     * Use this overload when the Consumer draws its icon away from the tab center
     * — passes the icon's drawn center to {@link CustomIconTab} so iconRotation
     * pivots around the icon and not a corner.
     */
