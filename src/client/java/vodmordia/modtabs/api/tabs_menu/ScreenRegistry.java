 ...
 * Fabric port from NeoForge version
 */
public class ScreenRegistry {
     ...
     */
    public static final Function<PlayerEntity, Integer> STANDARD_WIDTH = (player) -> 176;
    public static final Function<PlayerEntity, Integer> STANDARD_HEIGHT = (player) -> 166;
    public static final Function<PlayerEntity, Integer> BODY_HEALTH_HEIGHT = (player) -> 183;
    public static final Function<PlayerEntity, Integer> QUARK_BACKPACK_HEIGHT = (player) -> 224;
    public static final Function<PlayerEntity, Integer> DIET_WIDTH = (player) -> 248;

    /**
     * Builder for registering multiple screens with the same configuration
     */
    public static class ScreenRegistrationBuilder {
        private Function<PlayerEntity, Integer> widthFunction = STANDARD_WIDTH;
        private Function<PlayerEntity, Integer> heightFunction = STANDARD_HEIGHT;
        ...
        public ScreenRegistrationBuilder withDimensions(Function<PlayerEntity, Integer> width, Function<PlayerEntity, Integer> height) {
