 ...
 * own open logic ({@code NetworkHooks.openScreen} on the chest-slot backpack).
 */
...
public class QuarkBackpackTab extends IntegrationItemTab {
    private static final ResourceLocation BACKPACK_ITEM_ID = new ResourceLocation("quark", "backpack");
    ...
    public void openTargetScreen(Player player) {
        ...
        ModTabs.CHANNEL.sendToServer(new OpenQuarkBackpackPayload());
    }
